          ...
          <div className="flex flex-wrap justify-center -m-4">
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4 ">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                <h2 className="text-white font-medium mb-4 title-font tracking-wider text-sm">शिवानंद मिश्रा</h2>
              </div>
            </div>
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4 ">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                <span className="inline-block h-1 w-10 rounded text-white t-6 mb-4"></span>
                <h2 className="text-white font-medium mb-4 title-font tracking-wider text-sm">हफ़िज़ीयद्दीन मियां </h2>
              </div>
            </div>
            <div className="lg:w-1/3 lg:mb-0 p-4  ">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                <span className="inline-block h-1 w-10 rounded text-white  mt-6 mb-4"></span>
                <h2 className="text-white  mb-4 font-medium title-font tracking-wider text-sm">पूनम चंदेलिया</h2>
